...
\name{SN: 24076607, 21056106, 24055142, 21072758}
\address{}
%
\begin{document}
...
\subsection{SN: 24055142}
In this project, I was primarily responsible for breaking through network protection mechanisms and researching various cracking methods. I focused on studying and implementing techniques such as using Wireshark to capture information, employing cookie methods, SQL injection, and other fundamental network attack techniques. I wrote multiple sections of the report, including project introduction, impact analysis, risk prioritisation, and defence method descriptions. I also created and edited videos.

\subsection{SN: 21056106}
In this group assignment, I was primarily responsible for the Brute Force Attack and DDoS Attack sections. My tasks included analyzing the security risks posed by the initial version of the website, identifying potential vulnerabilities that could be exploited by these attack methods, and designing practical attack scenarios accordingly. I developed the scripts used to simulate both Brute Force and DDoS attacks, ensuring they effectively demonstrated the weaknesses in the system's authentication and availability layers. Additionally, I contributed to the preparation of the demonstration video by generating and proofreading the subtitles to ensure clarity and accuracy in our presentation.

\subsection{SN: 21072758}
In this project, I was responsible for developing an AI-based method to detect harmful or inappropriate language, to prevent it from entering the database. My contributions included sourcing suitable datasets and pre-trained models, training and fine-tuning the model, and successfully integrating the functionality into our web platform. Additionally, I recorded a demonstration video showcasing the feature and wrote the corresponding part in the report. 
